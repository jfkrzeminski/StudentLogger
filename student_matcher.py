...
log_file = f'logger_csv_files/student_log_{today_date}.csv'  # Make sure the filename matches the logging program's output
...
def save_to_csv(student_durations):
    output_file = f'logger_csv_files/student_durations_{today_date}.csv'
